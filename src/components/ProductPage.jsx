      ...
      <section className="container my-5 px-5 mx-auto flex flex-col lg:flex-row justify-center gap-3 sm:gap-6 lg:gap-10">
        <div className="PRODUCT w-[100%] lg:w-[25%] relative">
          <div className="image-product border border-gray-300 rounded shadow w-full">
            <img
              src={`https://i.dummyjson.com/data/products/${product.id}/${currentImg}.jpg`}
              alt=""
              className="w-full"
            />
          </div>
          <div className="switch bg-white flex justify-center mt-3 gap-3">
            {[1, 2, 3, "thumbnail"].map((imgNumber) => (
              <img
                ...
                src={`https://i.dummyjson.com/data/products/${product.id}/${imgNumber}.jpg`}
                alt=""
                className="w-[60px] border border-slate-400 cursor-pointer"
              />
            ))}
          </div>
        ...
        <div className="DESCRIPTION w-[100%] lg:w-[40%] bg-white p-3 border border-gray-400/50 rounded">
          <h1 className="text-xl md:text-2xl xl:text-3xl font-bold text-rose-400">
            {props.title}
          </h1>
          <div className="stok-deliver flex gap-20 py-6">
            <div className="stok flex gap-3 items-center">
              <svg
                ...
                className="feather text-rose-500 feather-check-circle"
              >
            ...
            <div className="delivery flex gap-2">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="feather text-gray-600 feather-arrow-right-circle"
              >
          ...
          <div className="variant">
            ...
            <h5 className="ukuran p-2 rounded-md cursor-pointer w-[30%] text-gray-800 text-sm">
              {props.beban}
            </h5>
          </div>
          <div className="desc">
        ...
        <div className="PRICE bg-white w-[100%] lg:w-[25%] h-[50%] flex flex-col items-center px-3 pb-10 pt-5 border border-gray-400/50 rounded">
          ...
          <div className="plus-minus flex justify-center items-center my-5">
            <button
              ...
              className="text-gray-900 hover:bg-slate-200 mx-3 p-1 px-2 rounded-full text-2xl"
            >
              -
            </button>
            <input
              value={quantity}
              type="number"
              className="outline-none border border-gray-400 text-center rounded w-[50%] focus:border-rose-500"
            />
            <button
              type="button"
          ...
          <div
            ...
            className="bg-rose-400 hover:bg-rose-500 font-bold text-white text-center cursor-pointer rounded-md p-2 w-full"
          >
            Tambah ke Keranjang
          </div>
          <p className={warning ? `text-red-500 mt-5 font-semibold` : "hidden"}>
