  ...
  return (
    <>
      {cartItems.map((item, index) => (
        <div
          key={index}
          className="flex mb-5 px-1 gap-2 py-2 sm:p-3 items-center h-[100px] sm:h-[120px] overflow-hidden justify-between shadow bg-white rounded-lg"
        >
            ...
            <form className="flex justify-center items-center">
              <div>
                ...
                <p
                  ...
                  className="cursor-pointer text-xs sm:text-sm text-rose-500 mt-2"
                >
                  Hapus
                </p>
              </div>
          ...
          <div className="price">
            <h3 className="text-lg sm:text-3xl text-rose-500">
